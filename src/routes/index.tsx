  ...
  head: () => ({
    meta: [
      { title: "NAVSHAKTHI — Where Culture Meets Crafts" },
      {
        name: "description",
        content:
          "AI-powered marketplace connecting India's rural artisans to the world with verified crafts, multilingual cataloguing, fair price guidance and direct commerce.",
      },
    ],
  }),
  component: Home,
...
function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="relative -mt-20 min-h-[100svh] overflow-hidden bg-earth"
    >
      <motion.div style={{ y }} className="absolute inset-0">
        <img
          src={heroImg}
          alt="Artisan at potter's wheel"
      ...
      <motion.div
        style={{ opacity }}
        className="relative z-10 container-x pt-40 pb-24 text-cream"
      >
        <motion.div
        ...
        >
          ...
          <p className="mt-8 max-w-xl text-lg leading-relaxed text-cream/80">
            An AI-powered marketplace bringing India's rural artisans onto a
            fair, verified and digitally enabled global stage.
          </p>

          <div className="mt-10 flex flex-wrap gap-4">
            <Link
              to="/marketplace"
              className="group inline-flex items-center gap-2 rounded-full bg-gold px-7 py-4 text-sm font-semibold text-earth shadow-warm hover:bg-gold/90"
            >
              Explore marketplace
            ...
            <Link
              to="/auth/signup"
              className="inline-flex items-center gap-2 rounded-full border border-cream/30 bg-white/5 px-7 py-4 text-sm font-semibold text-cream backdrop-blur hover:bg-white/10"
            >
              Become an artisan
            </Link>

            <Link
              to="/portal/government"
              className="hidden items-center gap-2 rounded-full px-4 py-4 text-sm font-medium text-cream/80 hover:text-gold sm:inline-flex"
            >
              Government portal →
            </Link>
          </div>
      ...
      <div className="container-x">
        ...
        <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4 lg:grid-cols-8">
          {partners.map((p) => (
            <div
              key={p}
              className="rounded-xl border border-border/60 bg-background/50 px-4 py-3 text-center font-display text-sm text-earth/70"
            >
              {p}
            </div>
          ))}
          ...
          {categories.map((c, i) => (
            <Reveal key={c.slug} delay={i * 0.05}>
              <Link
                ...
                className="group relative flex items-center gap-5 overflow-hidden rounded-3xl border border-border/60 bg-card p-6 hover-lift"
              >
                <div className="grid h-16 w-16 shrink-0 place-items-center rounded-2xl bg-mesh-warm text-3xl">
                  {c.icon}
                </div>
        ...
        <div className="flex items-end justify-between gap-6">
          <Reveal>
            <SectionHeading
              ...
              subtitle="AI-assisted verification, artisan stories and direct marketplace access."
            />
          </Reveal>

          <Link
            to="/marketplace"
            className="hidden items-center gap-2 rounded-full border border-border px-5 py-2.5 text-sm font-medium hover:bg-muted md:inline-flex"
          >
            View all
...
function ProblemSolution() {
  const items = [
    {
      tag: "The problem",
      title: "Artisans struggle to capture the full value of their craft.",
      desc: "Limited digital access, weak market reach, inconsistent product presentation and lack of transparent pricing can reduce the value received by rural makers.",
    },
    {
      tag: "Our solution",
      title: "AI assists. Government enables. Markets connect.",
      desc: "NAVSHAKTHI helps artisans transform a physical craft into a market-ready digital listing with better imagery, multilingual content, price guidance, verification support and direct access to buyers.",
    },
    {
      tag: "The impact",
      title: "Stronger livelihoods. Greater visibility. Living heritage.",
      desc: "By connecting artisans directly with digital markets and support ecosystems, NAVSHAKTHI aims to improve discoverability, transparency and sustainable income opportunities.",
    },
  ];
      ...
      <div className="container-x">
        <Reveal>
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 font-display text-4xl leading-[1.05] sm:text-5xl">
              A quiet revolution — measured in{" "}
              <span className="text-gradient-gold">
                villages, not vanity metrics.
              </span>
            </h2>
          </div>
        </Reveal>
        ...
        <div className="mt-14 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            {
              label: "Fair income growth",
              value: 312,
              suffix: "%",
            },
            {
              label: "AI verifications / day",
              value: 4200,
              suffix: "",
            },
            {
...
function PlatformFeatures() {
  const feats = [
    {
      icon: Sparkles,
      title: "AI authenticity engine",
      desc: "Multimodal AI assesses visual craft characteristics and provides an evidence-based assessment for review.",
    },
    {
      icon: ShieldCheck,
      title: "Craftmark & GI information",
      desc: "Present relevant certification and geographical-indication information alongside craft records.",
    },
    {
      icon: Landmark,
      title: "Scheme support",
      desc: "Connect artisans with relevant government and ecosystem support information.",
    },
    {
      icon: Truck,
      title: "Marketplace logistics",
      desc: "Support direct customer ordering and an organised fulfilment workflow from artisan to buyer.",
    },
    {
      icon: Award,
      title: "Reverse marketplace",
      desc: "Enable buyer requirements to become opportunities for artisans and makers.",
    },
    {
      icon: Wand2,
      title: "AI Image Studio",
      desc: "Background removal, image enhancement and catalog-ready formatting for craft photography.",
    },
    {
      icon: Languages,
      title: "Multilingual auto-cataloger",
      desc: "Speak in your language and generate structured product content suitable for digital listings.",
    },
    {
      icon: IndianRupee,
      title: "Smart pricing assistant",
      desc: "Combine craft information, material cost, labour benchmarks and market signals to provide price guidance.",
    },
  ];
      ...
      <div className="container-x">
        <Reveal>
          <SectionHeading
            ...
            title="Eight systems, one continuum."
            subtitle="An operating layer for the rural craft economy — from digitisation and discovery to commerce and impact."
          />
        </Reveal>
      ...
      <Reveal>
        <div className="relative overflow-hidden rounded-[2.5rem] bg-mesh-forest p-12 text-center text-cream lg:p-20">
          ...
          <p className="mx-auto mt-5 max-w-xl text-cream/80">
            Discover authentic craft stories, support artisan livelihoods and
            bring India's living heritage into everyday life.
          </p>

          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link
              to="/marketplace"
              className="rounded-full bg-gold px-8 py-4 text-sm font-semibold text-earth hover:bg-gold/90"
            >
            ...
            <Link
              to="/auth/signup"
              className="rounded-full border border-cream/30 px-8 py-4 text-sm font-semibold hover:bg-white/10"
            >
              Join as artisan
            </Link>
          </div>
