          ...
          <Reveal key={c.id} delay={i * 0.04}>
            <div>
              ...
              <div className="mx-auto mt-4 flex max-w-3xl justify-end">
                <button onClick={() => toast.success(`${c.title} downloaded`)} className="inline-flex items-center gap-2 rounded-full bg-primary px-4 py-2 text-xs font-semibold text-primary-foreground">
