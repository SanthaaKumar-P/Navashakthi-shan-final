...
function Overview() {
  const publishedProducts = useStoreData<PublishedProduct[]>(
    getPublishedProducts,
    [],
  );
    ...
    ...products.filter(
      (product) =>
        !publishedProducts.some(
          (published) => published.id === product.id,
        ),
    ),
  ].slice(0, 4);
  ...
  return (
    <>
      <PageHeader
        title="Welcome back."
        subtitle="Your NAVSHAKTHI journey — orders, wishlists and personalised recommendations."
      />
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Stat
          ...
          value="9"
          hint="Across 5 states"
        />
        <Stat
          label="Impact score"
          value="82"
          hint="Top 8% of buyers"
        />
      </div>
